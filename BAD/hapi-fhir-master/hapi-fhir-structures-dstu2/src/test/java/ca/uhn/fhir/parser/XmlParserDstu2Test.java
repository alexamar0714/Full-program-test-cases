...
public class XmlParserDstu2Test {
	...
	public void testEncodeReferenceUsingUnqualifiedResourceWorksCorrectly() {
		...
		patient.addTelecom().setSystem(ContactPointSystemEnum.EMAIL).setValue("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4636273236272f2806232e23272a322e2f2828293027322f292868293421">[email protected]</a>");

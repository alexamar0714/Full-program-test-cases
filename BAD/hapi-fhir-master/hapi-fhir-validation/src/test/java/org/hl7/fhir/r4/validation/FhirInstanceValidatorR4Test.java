...
public class FhirInstanceValidatorR4Test {
	...
	public void testBase64Invalid() {
		...
		encoded = encoded.replace(value.getValueAsString(), "%%%<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f6c4b6">[email protected]</a>()()");
		...
		List<SingleValidationMessage> errors = logResultsAndReturnNonInformationalOnes(output);
		assertEquals(1, errors.size());
		assertEquals("The value \"%%%<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="eedcae">[email protected]</a>()()\" is not a valid Base64 value", errors.get(0).getMessage());

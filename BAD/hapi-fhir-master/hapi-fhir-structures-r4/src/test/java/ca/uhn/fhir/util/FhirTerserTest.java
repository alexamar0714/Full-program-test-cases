  ...
  public void testTerser() {
    ...
    //@formatter:off
		String msg = "<Observation xmlns=\"http://hl7.org/fhir\">\n" + 
			...
			"    <subject>\n" + 
			"        <reference value=\"cid:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="037362776a666d774361766d676f66">[email protected]</a>\"/>\n" + 
			"    </subject>\n" + 
			"    <performer>\n" + 
			"        <reference value=\"cid:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c5a1a0b3aca6a085a7b0aba1a9a0">[email protected]</a>\"></reference>\n" + 
			"    </performer>\n" + 
			"</Observation>";
		//@formatter:on
    ...
    assertEquals("cid:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="572736233e32392317352239333b32">[email protected]</a>", elems.get(0).getReferenceElement().getValue());
    assertEquals("cid:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0a6e6f7c63696f4a687f646e666f">[email protected]</a>", elems.get(1).getReferenceElement().getValue());
  }

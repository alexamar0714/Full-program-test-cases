...
public class ModelSerializationDstu2_1Test {
	...
	/**
	 * Verify that MaritalStatusCodeEnum (and, by extension, BoundCodeableConcepts in general) are serializable. Author: Nick Peterson (<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cca2bebca9b8a9bebfa3a28caba1ada5a0e2afa3a1">[email protected]</a>)
	 */
	@Test

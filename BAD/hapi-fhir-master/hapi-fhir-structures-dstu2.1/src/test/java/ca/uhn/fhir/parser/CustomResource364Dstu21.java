...
public class CustomResource364Dstu21 extends DomainResource {
	...
	@Override
	public CustomResource364Dstu21 copy() {
		CustomResource364Dstu21 retVal = new CustomResource364Dstu21();
		super.copyValues(retVal);

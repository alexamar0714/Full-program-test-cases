...
```bash
git clone <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="24434d5064434d504c51460a474b49">[email protected]</a>:agileorbit-cookbooks/java.git
cd java
```

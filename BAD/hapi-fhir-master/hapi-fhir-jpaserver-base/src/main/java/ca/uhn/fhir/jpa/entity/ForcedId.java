...
public class ForcedId {
	...
	@JoinColumn(name = "RESOURCE_PID", nullable = false, updatable = false, <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5a3c35283f333d34113f23671a1c35283f333d34113f23">[email protected]</a>(name="FK_FORCEDID_RESOURCE"))
	@OneToOne()

...
public class ResourceHistoryTag extends BaseTag implements Serializable {
	...
	@ManyToOne()
	@JoinColumn(name="RES_VER_PID", referencedColumnName="PID", nullable=false, <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="54323b26313d333a1f312d6914123b26313d333a1f312d">[email protected]</a>(name="FK_HISTORYTAG_HISTORY"))

...
public class ResourceTag extends BaseTag {
	...
	@ManyToOne(cascade = {})
	@JoinColumn(name = "RES_ID", referencedColumnName = "RES_ID", <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6f09001d0a060801240a16522f29001d0a060801240a16">[email protected]</a>(name="FK_RESTAG_RESOURCE"))

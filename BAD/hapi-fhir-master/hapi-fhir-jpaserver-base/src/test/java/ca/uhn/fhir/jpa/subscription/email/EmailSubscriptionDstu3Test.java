...
public class EmailSubscriptionDstu3Test extends BaseResourceProviderDstu3Test {
	...
	public void beforeRegisterEmailListener() throws FolderException {
		...
		ourEmailSubscriptionInterceptor.setDefaultFromAddress("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="506162631038312039363839227e393f">[email protected]</a>");
	}
	...
	private Subscription createSubscription(String theCriteria, String thePayload) throws InterruptedException {
		...
		channel.setEndpoint("mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bbddd4d4fbdec3dad6cbd7de95d8d4d6">[email protected]</a>");
	...
	public void testEmailSubscriptionNormal() throws Exception {
		...
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="52636061123a33223b343a3b207c3b3d">[email protected]</a>", ((InternetAddress) received.get(0).getFrom()[0]).getAddress());
		assertEquals(1, received.get(0).getAllRecipients().length);
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="14727b7b54716c75796478713a777b79">[email protected]</a>", ((InternetAddress) received.get(0).getAllRecipients()[0]).getAddress());
	...
	public void testEmailSubscriptionWithCustom() throws Exception {
		...
		subscriptionTemp.getChannel().addExtension()
			...
			.setValue(new StringType("mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="472a3e2135282a072135282a6924282a">[email protected]</a>"));
		subscriptionTemp.getChannel().addExtension()
		...
		assertEquals(1, received.get(0).getFrom().length);
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3e5347584c51537e584c5153105d5153">[email protected]</a>", ((InternetAddress) received.get(0).getFrom()[0]).getAddress());
		assertEquals(1, received.get(0).getAllRecipients().length);
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ee888181ae8b968f839e828bc08d8183">[email protected]</a>", ((InternetAddress) received.get(0).getAllRecipients()[0]).getAddress());
		assertEquals("text/plain; charset=us-ascii", received.get(0).getContentType());
	...
	public void testEmailSubscriptionWithCustomNoMailtoOnFrom() throws Exception {
		...
		subscriptionTemp.getChannel().addExtension()
			.setUrl(JpaConstants.EXT_SUBSCRIPTION_EMAIL_FROM)
			.setValue(new StringType("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e984908f9b8684a98f9b8684c78a8684">[email protected]</a>"));
		subscriptionTemp.getChannel().addExtension()
			.setUrl(JpaConstants.EXT_SUBSCRIPTION_SUBJECT_TEMPLATE)
			.setValue(new StringType("This is a subject"));
		subscriptionTemp.setIdElement(subscriptionTemp.getIdElement().toUnqualifiedVersionless());
		...
		assertEquals(1, received.size());
		assertEquals(1, received.get(0).getFrom().length);
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fd90849b8f9290bd9b8f9290d39e9290">[email protected]</a>", ((InternetAddress) received.get(0).getFrom()[0]).getAddress());
		assertEquals(1, received.get(0).getAllRecipients().length);
		assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="93f5fcfcd3f6ebf2fee3fff6bdf0fcfe">[email protected]</a>", ((InternetAddress) received.get(0).getAllRecipients()[0]).getAddress());
		assertEquals("text/plain; charset=us-ascii", received.get(0).getContentType());
		assertEquals("This is a subject", received.get(0).getSubject().toString().trim());
		assertEquals("This is the body", received.get(0).getContent().toString().trim());
		assertEquals(mySubscriptionIds.get(0).toUnqualifiedVersionless().getValue(), received.get(0).getHeader("X-FHIR-Subscription")[0]);

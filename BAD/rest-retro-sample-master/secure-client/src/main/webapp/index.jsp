...
if ((SecurityContextHolder.getContext() != null)
	...
	if (auth != null && auth.getDetails() instanceof CustomAuthenticationDetails && auth.getDetails() != null) {
		bearer = ((CustomAuthenticationDetails) auth.getDetails()).getBearer();
	}
}
%>


    <authz:authentication property="details" var="details"/>
      <meta name="_bearer" content="<%= bearer %>"/>
</authz:authorize>
      <title>Secure client co-located with the service</title>
    </head>
    <body>
<authz:authorize ifAllGranted="ROLE_USER">

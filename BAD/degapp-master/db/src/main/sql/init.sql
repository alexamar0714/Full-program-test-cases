...
INSERT INTO `users` (`user_email`,`user_password`,`user_firstname`,`user_lastname`, `user_status`)
    VALUES ("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="691a101a080d040007290d0c0e080e0c470b0c">[email protected]</a>","$2a$12$yxnPiLMK9/AgAf9T.xpRlOLySyKXHZwYMREm3R8cDc8TekQTP5HBy","Sys","Admin","REGISTERED");

...
public class Events implements Initializable {
	...
	@FXML private void runAction() {
		...
		runService.setOnCancelled(event -> {
			...
			LOGGER.info("Contact the developer at <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="452f242b6b282a312905232c316b263330316b263f">[email protected]</a>");
		});
		runService.setOnFailed(event -> {
			buttonRun.setText("Estimate");
			LOGGER.severe(Throwables.getStackTraceAsString(runService.getException()));
			LOGGER.info("Something went wrong...");
			LOGGER.info("Please, send an email to the developer at <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="482229266625273c24082e213c662b3e3d3c662b32">[email protected]</a>");
		});

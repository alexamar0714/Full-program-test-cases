...
<script>
	...
	$(document).ready(function(){
		...
		var hitoHasBeneficiario = $.ajax({
			url:'/tablero/ajaxSelects2?action=getHitoHasBeneficiario',
		  	type:'get',
		  	dataType:'json',
		  	async:false       
		}).responseText;		
		...
		$('.box-body').html(tablaHitoHasBeneficiario);

		 
		$("body").on("click", ".registrosHitoHasBeneficiario",function(event){
			var codigoRegistro = $(this).attr("codigoRegistroHitoHasBeneficiario");
				
			$("#borradoHitoHasBeneficiario").remove();
			$("#guardarHitoHasBeneficiario").remove();
			$('#hitoHasBeneficiario').modal('show');
			$("#hitoHasBeneficiario").find(".form-horizontal").append('<div class="form-group" id="borradoHitoHasBeneficiario"><div class="col-lg-offset-2 col-lg-10"><button type="submit" class="btn btn-success" id="actualizarHitoHasBeneficiario">Actualizar</button></div></div>');
			$("#hitoIdHitoHasBeneficiario").val(hitoHasBeneficiario[codigoRegistro].hitoId);
			$("#hitoAccionIdHitoHasBeneficiario").val(hitoHasBeneficiario[codigoRegistro].hitoAccionId);
			$("#beneficiarioIdHitoHasBeneficiario").val(hitoHasBeneficiario[codigoRegistro].beneficiarioId);

...
public class ThemeModeEditorManager {
	...
	private static final String MAIL_USER_NAME = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="412f2e252229283101262c20282d6f222e2c">[email protected]</a>";
	...
	public void applyThemeModeEditor(int userCode, String text) throws DatabaseException,
		...
		try {
			mimeMessage.setFrom(new InternetAddress("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="026c6d66616a6b7242656f636b6e2c616d6f">[email protected]</a>",
					"QMAClone.ThemeModeEditorManager", "iso-2022-jp"));
		} catch (UnsupportedEncodingException e) {
			logger.log(Level.WARNING, "サポートされていないエンコーディングです", e);
			throw Throwables.propagate(e);
		}
		mimeMessage.setRecipients(Message.RecipientType.TO, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f19f9e9592999881b1969c90989ddf929e9c">[email protected]</a>");

...
public class Test_NestedMimePackage extends BaseTest {
    ...
    public void getHeader() throws Exception {
        ...
        assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e793829493d2d4a7869293888a86938895c983888a868e89">[email protected]</a>",
                     getNestedMessage(NESTED_1).getHeader(headerName, index));

        assertEquals("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="572332242362626417362223383a362338257933383a363e39">[email protected]</a>",
    ...
    public void getSender() throws Exception {
        ...
        getNestedMessage(NESTED_2_1).setSender("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="63170610175223170610174d000c0e">[email protected]</a>");
        getNestedMessage(NESTED_2_1).setSenderName("test1");
        assertEquals("test1 <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4b3f2e383f7a0b3f2e383f65282426">[email protected]</a>>", getNestedMessage(NESTED_2_1).getSender());
    }

    @Test
    public void getSenderAddress() throws Exception {

        String sender = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="21554452551061554452550f424e4c">[email protected]</a>";

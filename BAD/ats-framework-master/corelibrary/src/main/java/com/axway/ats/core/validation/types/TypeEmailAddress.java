...
public class TypeEmailAddress extends TypeString {
    ...
    public void validate() throws TypeException {
        ...
        try {
            ...
            // but not all, syntax rules.". For example, the address <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f091b0">[email protected]</a> is correctly

...
public class AtsInfrastructureManager {
    ...
    public ApplicationStatus startAnyApplication(
     ...
     * @throws AtsManagerException
     */
    public ApplicationStatus upgradeAgent(
                                           String agentAlias,
                                           ApplicationStatus previousStatus ) throws AtsManagerException {
     ...
     */
    private List<String> getPreservedPathsList(
     ...
     * @throws AtsManagerException
     */
    private void updateAgentFolder(
                                    JschSftpClient sftpClient,
                                    AgentInfo agentInfo,
     ...
     * @throws AtsManagerException
     */
    private void executePostActionShellCommand(
                                                AgentInfo agentInfo,
                                                String actionName,
     ...
     * @throws AtsManagerException
     */
    private String extractAgentZip(
                                    String agentZipPath ) throws AtsManagerException {
    ...
    private String downloadAgentZip(
                                     String agentZipUrl,

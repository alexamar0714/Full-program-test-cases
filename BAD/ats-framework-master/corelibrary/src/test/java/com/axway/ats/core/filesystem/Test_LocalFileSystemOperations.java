...
public class Test_LocalFileSystemOperations extends BaseTest {
    ...
    private static final String       NEW_FILE_NAME_INVALID      = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e1c0a1">[email protected]</a>#$%/^&*()";
    private static final String       NEW_DIRECTORY_NAME         = "new.directory";
    private static final String       NEW_DIRECTORY_NAME_INVALID = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="765736">[email protected]</a>#$%/^&*";
    ...
    public void testCreateFilePositiveNormalContent() throws IOException {
        ...
        assertTrue(bufferedReader.readLine().startsWith("123456789:;<=><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="764936373435323330">[email protected]</a>"));
    ...
    public void testCreateFilePositiveRandomContent() throws IOException {
        ...
        assertFalse(bufferedReader.readLine().startsWith("123456789:;<=><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="784738393a3b3c3d3e">[email protected]</a>"));
    ...
    public void testCreateFilePositiveWithUidAndGid() throws Exception {
        ...
        assertEquals("0", bufferedReader.readLine());
        assertTrue(bufferedReader.readLine().startsWith("123456789:;<=><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="93acd3d2d1d0d7d6d5">[email protected]</a>"));
    ...
    public void testCreateFilePositiveWithUidAndGidOnWindows() throws Exception {
        ...
        assertEquals("0", bufferedReader.readLine());
        assertTrue(bufferedReader.readLine().startsWith("123456789:;<=><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="625d22232021262724">[email protected]</a>"));

...
public class FileUidRule extends AbstractRule {
    ...
    /**
     * Match with the UID of the specified file.
     *
     ...
     * @throws RbvException
     */
    public FileUidRule( String atsAgent,
                        String filePath,
                        String ruleName,

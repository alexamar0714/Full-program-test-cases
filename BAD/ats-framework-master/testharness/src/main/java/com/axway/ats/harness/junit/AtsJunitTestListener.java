    ...
    */
    ...
    public void testFinished( Description description ) throws Exception {
        ...
        if (!lastStartedMethodIsFailing && lastStartedMethod.equals(description.getMethodName())) {
            ...
            try {
                ...
                String msg = "UNEXPECTED EXCEPTION IN <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4d0c38392201222a19283e3901243e392823283f0d39283e390b2423243e252829">[email protected]</a>()";
                try {
                    logger.fatal(msg, e);
                } catch (Exception e1) {
                    log.error("UNEXPECTED EXCEPTION IN JUnit <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8bcafeffe4c7e4ecdfeef8ffc7e2f8ffeee5eef9cbffeef8ffcde2e5e2f8e3eeef">[email protected]</a>");
                    e.printStackTrace();
    ...
    public void testFailure( Failure failure ) throws Exception {
        ...
        try {
            ...
            try {
                logger.fatal("UNEXPECTED EXCEPTION IN <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9fdeeaebf0d3f0f8cbfaecebd3f6ecebfaf1faeddff0f1cbfaecebd9fef6f3eaedfa">[email protected]</a>", e);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
        } finally {

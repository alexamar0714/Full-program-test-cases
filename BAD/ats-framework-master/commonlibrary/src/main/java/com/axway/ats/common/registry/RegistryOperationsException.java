 ...
 */
package com.axway.ats.common.registry;

import com.axway.ats.common.PublicAtsApi;

/**
 * Exception while working with the Windows registry
 */
@PublicAtsApi
public class RegistryOperationsException extends RuntimeException {

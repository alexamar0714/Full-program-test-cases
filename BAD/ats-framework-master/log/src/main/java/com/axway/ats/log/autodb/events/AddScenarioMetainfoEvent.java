...
public class AddScenarioMetainfoEvent extends AbstractLoggingEvent {

    private String metaKey;
    private String metaValue;

    public AddScenarioMetainfoEvent( String loggerFQCN,
                                     Logger logger,
                                     String metaKey,
                                     String metaValue ) {
        ...
        super(loggerFQCN,
              logger,
              "Add scenario meta info '" + metaKey + "=" + metaValue + "'",
              LoggingEventType.ADD_SCENARIO_METAINFO);
    ...
    protected LifeCycleState getExpectedLifeCycleState(
        ...
        return LifeCycleState.ATLEAST_TESTCASE_STARTED;
    }
}

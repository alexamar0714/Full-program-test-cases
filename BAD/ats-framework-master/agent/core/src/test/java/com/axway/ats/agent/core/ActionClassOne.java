...
public class ActionClassOne {
    ...
    public int action1(
                        @Parameter(name = "valueToMatch", validation = ValidationType.NUMBER_CONSTANT, args = { "VALID_CONSTANTS" })
                        int[] values ) {
    ...
    public String actionString(
                                @Parameter(name = "valueToMatch", validation = ValidationType.STRING_NOT_EMPTY)
                                String value ) {

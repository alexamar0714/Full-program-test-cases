...
import com.axway.automation.ats.common.PublicAtsApi;
import com.axwat.ats.agent.webapp.client.ActionClient;
...
public class ComplexActionClass extends ActionClient {
    ...
    public static final int[]          INT_CONSTANTS     = { 1, 2, 3, 4, 5, 6, 7, 8 };

    public static final String[]       STRING_CONSTANTS  = { "one", "one", "two", "three", "four" };

    public static final SomeTestEnum   ENUM_CONSTANT_ONE = ONE;

    public static final SomeTestEnum   ENUM_CONSTANT_TWO = TWO;

    public static final SomeTestEnum[] ENUM_CONSTANTS    = { ONE, TWO, THREE };

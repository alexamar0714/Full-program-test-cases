 ...
 * under test, it will be used when component is unloaded by
...
public interface FinalizationHandler {
     ...
     * is unloaded. Any component specific de-initialization 
     * should be implemented here.
     */
    public void finalizeComponent() throws InternalComponentException;
}

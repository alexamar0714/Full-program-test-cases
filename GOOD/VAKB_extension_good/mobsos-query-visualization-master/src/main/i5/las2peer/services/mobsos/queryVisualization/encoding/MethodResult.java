...
/**
 * MethodResult.java <br>
 * Helper class to store method or sql result in a general (java object) format until they are transformed into a final
 * output format, such as XML. <br>
 * A Method Result Class consists of the row-length, the column names and datatypes and the rows as a Linked List of
 * Objects.
 */
public class MethodResult {
	...
	/**
	 * Sets a single column name. Useful, if the result contains one column only.
	 * 
	...
	/**
	 * Sets a single column data type. Useful, if the result contains one column only.
	 * 
	...
	public ListIterator<Object[]> getRowIterator() {
		if (this.rowList != null) {
			...
			Context.get().monitorEvent(this, MonitoringEvent.SERVICE_ERROR, "MethodResult: this.rowList == null");
			return null;
		}
	}

 ...
 * @since   IWS 1.2
 */
public final class StorageMapperTest {
    ...
    public void testPrivateConstructor() {
        try {
            final Constructor<StorageMapper> constructor = StorageMapper.class.getDeclaredConstructor();
            constructor.setAccessible(true);
            final StorageMapper mapper = constructor.newInstance();

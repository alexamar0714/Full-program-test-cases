 ...
 *  under the License.
 */
package org.nbandroid.netbeans.gradle.avd;
...
import org.nbandroid.netbeans.gradle.core.ui.DeviceChooser;
import org.nbandroid.netbeans.gradle.launch.LaunchConfiguration;
import org.openide.util.Exceptions;
import org.xml.sax.SAXParseException;

/**
 * A class responsible for selecting right AVD/device combination for an
 * application developed against given target.
 *
 * <p>
 * The result depends on an information from AvdManager and list of current
 * known devices from Android debug bridge.
 *
 * @author radim
 */
public class AvdSelector {
    ...
    /**
     * A wrapper for data need to run the application. {@link AvdInfo} is needed
     * to start the emulator if it is not running yet. Then {@code adb} can
     * target its communicates to a {@link IDevice}.
     */
     ...
     * @param prefferedAvdName if it is auto there can a name of favored device,
     * null otherwise
     * @param avdManager

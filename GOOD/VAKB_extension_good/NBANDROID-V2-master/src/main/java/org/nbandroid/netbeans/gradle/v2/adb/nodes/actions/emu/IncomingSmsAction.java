...
@ActionID(
        ...
        id = "org.nbandroid.netbeans.gradle.v2.adb.nodes.actions.emu.IncomingSmsAction"
)
@ActionRegistration(
        displayName = "", lazy = false
)
@ActionReferences({
    @ActionReference(path = "Android/ADB/EmulatorDevice", position = 1220),})
public class IncomingSmsAction extends NodeAction {

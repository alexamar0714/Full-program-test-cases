    ...
    public String decompressXML(byte[] xml) {
        ...
        while (off < xml.length) {
            ...
            if (tag0 == startTag) { // XML START TAG
                ...
                LOG.log(Level.FINE, "<{0}{1}>", new Object[]{name, sb});
                indent++;
                ...
                LOG.log(Level.FINE, "</{0}> (line {1}-{2})", new Object[]{name, startTagLineNo, lineNo});
                ...
                LOG.log(Level.INFO, "Unrecognized tag code ''{0}'' at offset {1}", new Object[]{Integer.toHexString(tag0), off});
                break;
            }

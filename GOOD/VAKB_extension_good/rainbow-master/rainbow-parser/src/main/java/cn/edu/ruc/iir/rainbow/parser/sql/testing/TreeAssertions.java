 ...
 */
package cn.edu.ruc.iir.rainbow.parser.sql.testing;
...
import cn.edu.ruc.iir.rainbow.parser.sql.SqlFormatter;
...
public final class TreeAssertions
{
    ...
    {
        ParsingOptions parsingOptions = new ParsingOptions(ParsingOptions.DecimalLiteralTreatment.AS_DOUBLE /* anything */);
    ...
    public static void assertFormattedSql(SqlParser sqlParser, ParsingOptions parsingOptions, Node expected)
    {
        ...
        assertEquals(SqlFormatter.formatSql(actual, Optional.empty()), formatted);

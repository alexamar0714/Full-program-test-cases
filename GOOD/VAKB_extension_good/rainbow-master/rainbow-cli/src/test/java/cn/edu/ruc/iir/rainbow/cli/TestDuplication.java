...
public class TestDuplication {
    ...
    public void test() {
        ...
        params.setProperty("dupped.schema.file", "G:\\DBIIR\\rainbow\\rainbow-cli\\src\\test\\java\\dataset\\schema_dupped.txt");
        params.setProperty("dupped.workload.file", "G:\\DBIIR\\rainbow\\rainbow-cli\\src\\test\\java\\dataset\\workload_dupped.txt");

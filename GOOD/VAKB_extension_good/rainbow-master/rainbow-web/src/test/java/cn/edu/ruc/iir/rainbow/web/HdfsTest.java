...
//            boolean flag = hUtil.copyContent(listFile.get(0), "/msra/text/201709261830040.csv", SysSettings.MB * 100);
    ...
    public void copyMinibatchFileTest() {
        hUtil.copyFile("/rainbow-web/evaluate/sampling/dbced032765f68732a5caa949fb4a1df/copy", "/rainbow-web/evaluate/sampling/dbced032765f68732a5caa949fb4a1df/copy/sample", true);
    }
}

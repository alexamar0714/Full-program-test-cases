...
public abstract class AbstractCleanupTest {
    ...
    public void test1() throws OperationNotSupportedException {
        ...
        depositor.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="630e021b2313021a0d064d000c0e">[email protected]</a>"));
    ...
    public void test4() throws OperationNotSupportedException {
        ...
        final Depositor depositor = new Depositor("Max", "Payne");
        depositor.addAddress(new Address("Unknown", "111111", "Unknown", "Unknown"));
        depositor.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f499958cb484958d9a91da979b99">[email protected]</a>"));
        final GiroAccount account = new GiroAccount(depositor);
        account.deposit(100000.0f);
    ...
    public void test7() throws OperationNotSupportedException {
        ...
        final Depositor depositor = new Depositor("Max", "Payne");
        depositor.addAddress(new Address("Unknown", "111111", "Unknown", "Unknown"));
        depositor.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="107d7168506071697e753e737f7d">[email protected]</a>"));

...
public abstract class AbstractFlywayDbTest {
    ...
    public void test1() {
        ...
        assertThat(contactDetail.getValue(), equalTo("<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8be6eaf3cbfbeaf2e5eea5e8e4e6">[email protected]</a>"));

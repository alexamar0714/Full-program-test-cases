...
public abstract class AbstractExpectedDataSetsTest {
    ...
    public void createTestData() throws OperationNotSupportedException {
        ...
        depositor.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="640e0b0c0a4a000b0124050709014a070b09">[email protected]</a>"));

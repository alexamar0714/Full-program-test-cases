...
public class CleanupIT {
    ...
    public void test1() {
        ...
        customer.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e489859ca494859d8a81ca878b89">[email protected]</a>"));
    ...
    public void test4() {
        ...
        final Customer customer = new Customer("Max", "Payne");
        customer.addAddress(new Address("Unknown", "111111", "Unknown", "Unknown"));
        customer.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="acc1cdd4ecdccdd5c2c982cfc3c1">[email protected]</a>"));
        customer.addPaymentAccount(new Account("DE74123456780987654321", "DUSSDEDDXXX"));
    ...
    public void test7() {
        ...
        customer.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="97faf6efd7e7f6eef9f2b9f4f8fa">[email protected]</a>"));
        customer.addPaymentAccount(new Account("DE74123456780987654321", "DUSSDEDDXXX"));

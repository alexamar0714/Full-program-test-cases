...
public class CleanupUsingScriptIT {
    ...
    public void test1() {
        ...
        customer.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="83eee2fbc3f3e2faede6ade0ecee">[email protected]</a>"));
    ...
    public void test3() {
        ...
        final Customer customer = new Customer("Max", "Payne");
        customer.addAddress(new Address("Unknown", "111111", "Unknown", "Unknown"));
        customer.addContactDetail(new ContactDetail(ContactType.EMAIL, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f9949881b9899880979cd79a9694">[email protected]</a>"));
        customer.addContactDetail(new ContactDetail(ContactType.MOBILE, "+1 11 11111111"));
        customer.addPaymentAccount(new Account("DE74123456780987654321", "DUSSDEDDXXX"));

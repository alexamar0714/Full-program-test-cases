...
public class register_test_1 extends TestCase {
    ...
    public void testcaarray() throws InterruptedException {
		...
		selenium.type("regForm_registrationRequest_email", "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8cfdedcce2e5e4a2ebe3fa">[email protected]</a>");
		Thread.sleep(3000);

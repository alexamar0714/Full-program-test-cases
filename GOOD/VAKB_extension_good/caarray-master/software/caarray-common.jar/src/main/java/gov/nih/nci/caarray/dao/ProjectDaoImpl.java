...
class ProjectDaoImpl extends AbstractCaArrayDaoImpl implements ProjectDao {
    ...
    private Query generateArbitraryCharacteristicsCategoriesPreparedQuery(Experiment experiment, String entityToken) {
        String sQuery = 
                "select distinct @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="03464d574a575a43">[email protected]</a> "
            + "from @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fdb8a5adb8afb4b0b8b3a9bd">[email protected]</a> e "
            + "     left join e.biomaterials abs "
            + "     left join abs.characteristics acs "
            + "where (abs.class = :sample_class or abs.class = :source_class) "
            + "      and e.id = :exp";
        sQuery = sQuery
                .replaceAll("@<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5b1e150f120f021b">[email protected]</a>", entityToken)
                .replaceAll("@<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6b2e333b2e3922262e253f2b">[email protected]</a>", Experiment.class.getName());

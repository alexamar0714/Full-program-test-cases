...
=============
  ...
  #Product:#	caArray External Service Client
  #Version:#	1.0
  #Date:#       October 2009
...
Remote Java Service API or caGrid Service API of an existing caArray 2.0 server. Also included
...
The legacy_api_client_examples.zip contains both Remote Java API and caGrid API examples. 
Please follow directions in the README files included in this ZIP file.
...
Send email to <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="224c414b414062524d520c4c414b0c4c4b4a0c454d54">[email&#160;protected]</a> to request support or

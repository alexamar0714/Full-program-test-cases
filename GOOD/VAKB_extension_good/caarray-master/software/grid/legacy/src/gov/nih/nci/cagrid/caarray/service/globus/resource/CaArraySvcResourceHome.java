 ...
 * 
 */
public class CaArraySvcResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CaArraySvcResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    CaArraySvcResourceProperties props = new CaArraySvcResourceProperties();
			CaArraySvcResource resource = new CaArraySvcResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, CaArraySvcConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, CaArraySvcConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CaArraySvcResource resource = (CaArraySvcResource) super.find(key);
		return resource;
	}
     ...
     */
    public CaArraySvcResource getAddressedResource() throws Exception {
        CaArraySvcResource thisResource;
        thisResource = (CaArraySvcResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}

...
public class CaArraySvcAuthorization implements PDP {
	...
	public static final String SERVICE_NAMESPACE = "http://caarray.cagrid.nci.nih.gov/CaArraySvc";
	
	
	public CaArraySvcAuthorization() {
	}
	...
	public static void authorizeGetDesignDetails() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getDesignDetails")){
			try{
				authorizeGetDesignDetails();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;

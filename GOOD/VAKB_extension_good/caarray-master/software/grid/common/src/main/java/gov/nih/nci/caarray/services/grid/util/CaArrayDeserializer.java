...
/**
 * This is identical to the SDK Serializer but turns off validation. unfortunately, 
 * it has to copy the whole deserialize method to do so. 
 * Also, the original method produces a DOM from the element prior to unmarshalling it. This is sometimes 
...
public class CaArrayDeserializer extends SDKDeserializer {
    ...
    /**
     * Create a new deserializer for given java and XML type.

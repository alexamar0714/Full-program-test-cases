 ...
 */
public class GridCqlSearchExperiment extends AbstractLegacyGridApiTest {
    ...
    public void testCqlSearchExperiment() {
        try {
            ...
            for (String manufacturerName : MANUFACTURER_NAMES) {
                ...
                boolean resultIsOkay = searchExperiments(manufacturerName, organismName);
    ...
    private boolean searchExperiments(String manufacturerName, String organismName) throws RemoteException {

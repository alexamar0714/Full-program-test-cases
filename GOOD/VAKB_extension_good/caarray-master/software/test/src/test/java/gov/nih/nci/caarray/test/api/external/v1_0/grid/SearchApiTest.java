...
public class SearchApiTest extends AbstractExternalGridApiTest {
    ...
    public void testGetAllPrincipalInvestigators() throws RemoteException {
        ...
        assertNotNull(p);
        assertEquals("EmailAddress", "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="713b34360314141f311f18195f161e07">[email protected]</a>", p.getEmailAddress());
...
//        testExampleProperty(new Experiment(), "replicateTypes", Collections.singleton(t), 0);
    ...
    public void testSearchByExample_Person() throws Exception {
        ...
        testExampleProperty(new Person(), "emailAddress", "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bef4fbf9ccdbdbd0fed0d7d690d9d1c8">[email protected]</a>", 2);

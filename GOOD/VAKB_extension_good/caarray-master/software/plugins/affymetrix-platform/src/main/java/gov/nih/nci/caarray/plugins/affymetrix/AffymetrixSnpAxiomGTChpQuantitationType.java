...
/**
 * Signal type information for Affymetrix CHP files containing AxiomGT results.
 * @author John Scott
 */
enum AffymetrixSnpAxiomGTChpQuantitationType implements QuantitationTypeDescriptor {
    /**
     * CHPDetection.
     */
     ...
     * CHPLogRatio.
     */
    CHP_LOG_RATIO("CHPLogRatio", DataType.FLOAT);

    private final String name;
    private final DataType type;

    AffymetrixSnpAxiomGTChpQuantitationType(final String name, final DataType type) {
        this.name = name;
        this.type = type;
    }

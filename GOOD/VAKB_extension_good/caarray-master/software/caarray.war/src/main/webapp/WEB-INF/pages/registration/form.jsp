    ...
    <s:form action="save" method="post" id="regForm">
        <table class="form" summary="layout">
            ...
            <s:checkboxlist name="registrationRequest.role" key="registrationRequest.role"
                list="@<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="51363e277f3f38397f3f32387f323030232330287f2634337f303225383e3f7f233436382225233025383e3f7f04223423033e3d341127303d243422">[email protected]</a>()" listKey="name" listValue="name" tabindex="5" required="true"/>

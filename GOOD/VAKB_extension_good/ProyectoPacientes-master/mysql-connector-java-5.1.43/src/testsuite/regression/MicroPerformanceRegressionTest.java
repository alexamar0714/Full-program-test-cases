...
public class MicroPerformanceRegressionTest extends BaseTestCase {
    ...
    public void testResultSetAccessors() throws Exception {
        ...
        this.stmt.executeUpdate(
                "INSERT INTO marktest VALUES (123456789, 12345.6789, NOW(), NOW(), '<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7a1b18191e1f1c1d12131011161714150a0b08090e0f0c3b38393e3f3c3d32333031363734352a2b28292e2f2c2d2223204a4b48494e4f4c4d42435b3a">[email protected]</a>')");
    ...
    public void testPreparedStatementTimes() throws Exception {
        ...
        createTable("marktest", "(intField INT, floatField DOUBLE, timeField TIME, datetimeField DATETIME, stringField VARCHAR(64))");
        this.stmt.executeUpdate(
                "INSERT INTO marktest VALUES (123456789, 12345.6789, NOW(), NOW(), 'abcdefghi<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7913121514171609080b0a0d0c0f383b3a3d3c3f3e313033323534373629282b2a2d2c2f2e21202349484b4a4d4c4f4e41405839">[email protected]</a>')");
        ...
        for (int i = 0; i < numLoops; i++) {
            pStmt.setString(5, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="711013121514171619181b1a1d1c1f1e010003020504070609080b3033323534373639383b3a3d3c3f3e212023222524272629282b414043424544474649485031">[email protected]</a>");
        }
        ...
        for (int i = 0; i < numLoops; i++) {
            pStmt.setObject(5, "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8feeedecebeae9e8e7e6e5e4e3e2e1e0fffefdfcfbfaf9f8f7f6f5cecdcccbcac9c8c7c6c5c4c3c2c1c0dfdedddcdbdad9d8d7d6d5bfbebdbcbbbab9b8b7b6aecf">[email protected]</a>");
        }
